...
这次评估覆盖了 5 种 harness：
 ...
 claude_code
 Anthropic 原生 Agent 循环，用 XML 格式做工具调用

 smolagents_code
 让模型写 Python 代码来调用工具，然后执行

 tool_calling
 标准 JSON function-calling，一次一个工具
...
- Agent Harness for Large Language Model Agents: A Survey — GloriaaaM，2026-04-09。https://huggingface.co/datasets/GloriaaaM/LLM-Agent-Harness-Survey
